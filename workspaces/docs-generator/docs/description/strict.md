...
This rule disallows strict mode directives, no matter which option is specified, if ESLint configuration specifies either of the following as [parser options](https://github.com/eslint/eslint/tree/refs/tags/master/docs/src/use/configure/language-options#specifying-javascript-options):
...
* `"sourceType": "commonjs"` in [language options](https://github.com/eslint/eslint/tree/refs/tags/master/docs/src/use/configure/language-options#specifying-javascript-options)
* `"globalReturn": true` property in the `ecmaFeatures` object of [parser options](https://github.com/eslint/eslint/tree/refs/tags/master/docs/src/use/configure/language-options#specifying-parser-options)
