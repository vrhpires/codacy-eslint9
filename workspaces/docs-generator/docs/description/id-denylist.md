...
**Note:** The first element of the array is for the rule severity (see [Configure Rules](https://github.com/eslint/eslint/tree/refs/tags/master/docs/src/use/configure/rules)). The other elements in the array are the identifiers that you want to disallow.
